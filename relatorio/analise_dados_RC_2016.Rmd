...
Foram feitas tabelas de contingência de dados categóricos de contagens. A significância da associação desses dados foi feita utilizando-se o teste exato de Fisher.
