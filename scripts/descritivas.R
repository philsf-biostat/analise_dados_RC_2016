...
t <- CreateCatTable(vars = c("Tipo_Cirurgia", "Estadiamento", "Tipo_Histologico", "Presenca_Metastase", "Obito"), strata = "tempo.diagnostico", data = dados, argsExact = list(workspace = 2 * 10^6))
