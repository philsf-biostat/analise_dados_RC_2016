...
dados$tempo.diagnostico <- cut(dados$dt.diag, breaks = c(0, 90, 180, 365, 1095, Inf), right = F, ordered_result = T, labels = c("< 3meses", "3 A 6 meses", "6m a 1 ano", "1 a 3 anos", "> 3 anos"))
